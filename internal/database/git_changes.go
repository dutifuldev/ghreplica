...
type RepoChangeSyncState struct {
	...
	LastRecentPRRepairRequestedAt     *time.Time `gorm:"index"`
	...
	RecentPRRepairLeaseHeartbeatAt    *time.Time `gorm:"index"`
	RecentPRRepairLeaseUntil          *time.Time `gorm:"index"`
	FullHistoryCursorPage             int
	...
	FullHistoryRepairLeaseUntil       *time.Time `gorm:"index"`

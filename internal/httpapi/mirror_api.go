...
func newMirrorRepositoryStatusResponse(status gitindex.RepoStatus) mirrorRepositoryStatusResponse {
	return mirrorRepositoryStatusResponse{
		...
		Activity: mirrorActivityResponse{
			...
			RecentPRRepairPending:     status.RecentPRRepairPending,
			RecentPRRepairRunning:     status.RecentPRRepairRunning,
			FullHistoryRepairRunning:  status.FullHistoryRepairRunning,
		...
		Timestamps: mirrorStatusTimestampsResponse{
			...
			LastRecentPRRepairRequestedAt:   utcTimePtr(status.LastRecentPRRepairRequestedAt),
			LastRecentPRRepairStartedAt:     utcTimePtr(status.LastRecentPRRepairStartedAt),
			LastRecentPRRepairFinishedAt:    utcTimePtr(status.LastRecentPRRepairFinishedAt),
			LastFullHistoryRepairStartedAt:  utcTimePtr(status.LastFullHistoryRepairStartedAt),
			LastFullHistoryRepairFinishedAt: utcTimePtr(status.LastFullHistoryRepairFinishedAt),
		},
	}
}

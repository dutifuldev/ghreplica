...
func Load() Config {
	return Config{
		...
		ControlDBMaxOpenConns:      intDefault("DB_CONTROL_MAX_OPEN_CONNS", 3),
		ControlDBMaxIdleConns:      intDefault("DB_CONTROL_MAX_IDLE_CONNS", 1),
		SyncDBMaxOpenConns:         intDefault("DB_SYNC_MAX_OPEN_CONNS", 4),
		SyncDBMaxIdleConns:         intDefault("DB_SYNC_MAX_IDLE_CONNS", 1),

...
func Load() Config {
	return Config{
		...
		ControlDBMaxOpenConns:          intDefault("DB_CONTROL_MAX_OPEN_CONNS", 8),
		ControlDBMaxIdleConns:          intDefault("DB_CONTROL_MAX_IDLE_CONNS", 4),
		QueueDBMaxOpenConns:            intDefault("DB_QUEUE_MAX_OPEN_CONNS", 4),
		QueueDBMaxIdleConns:            intDefault("DB_QUEUE_MAX_IDLE_CONNS", 4),
		SyncDBMaxOpenConns:             intDefault("DB_SYNC_MAX_OPEN_CONNS", 8),
		SyncDBMaxIdleConns:             intDefault("DB_SYNC_MAX_IDLE_CONNS", 4),
